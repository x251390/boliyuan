    ...
    <div class="ps_floatright">
        ...
        <div class="psright">
            ...
            <div class="answer">
                ...
                <p class="Buying_guide_pic"><img src="/img/Buying_guide1.png"></p>
                <p class="directory_indent">
                    1-2. 加入购物车以后，我们点击上面的购物车，点击打开</p>
                <p class="Buying_guide_pic"><img src="/img/Buying_guide2.png"></p>
                <p class="directory_indent">
                    1-3. 打开以后，我们可以在购物车里面看到我们所有添加到购物车里面的东西，我们把我们在一个店铺里购买的产品前面打上对勾，这样我们就可以直接全部购买了。不用一次一次的分开了。</p>
                <p class="Buying_guide_pic"><img src="/img/Buying_guide3.png"></p>
                <p class="directory_indent">1-4. 选上以后，我们要进行点击下面的结算这个按钮</p>
                <p class="Buying_guide_pic"><img src="/img/Buying_guide4.png"></p>
                <p class="directory_indent">1-5. 然后接下来我们会进行地址的选择，我们可以找自己的地址  如果不对 我们点击下面的修改地址。</p>
                <p class="Buying_guide_pic"><img src="/img/Buying_guide5.png"></p>
                <p class="directory_indent">1-6. 地址确认无误以后，我们直接就可以点击下面的提交订单了 </p>
                <p class="Buying_guide_pic"><img src="/img/Buying_guide6.png"></p>
                <p class="directory_indent">
                    1-7. 然后我们看一下我们买的东西的店铺，如果没有错误的情况下，您可以选择您需要的支付方式，进行付款。</p>
                <p class="Buying_guide_pic"><img src="/img/Buying_guide7.png"></p>
                <p class="directory_indent">
                    1-8. 如果我们都输入的正确的情况下，我们就可以看到了付款成功的这个界面了，这个就证明我们已经全部成功了。</p>
                <p class="Buying_guide_pic"><img src="/img/Buying_guide8.png"></p>
                <p class="red_ans">2. 如何查看订单</p>
                <p class="directory_indent">
                    2-1. 我们买过以后，如果我们要查看订单，我们就点击主页上面的我的订单，点开就可以看到我买东西。</p>
                <p class="Buying_guide_pic"><img src="/img/Buying_guide9.png"></p>
                <p class="directory_indent">
                    2-2. 打开以后，我们就可以看到我们买的这个东西的情况了。</p>
                <p class="Buying_guide_pic"><img src="/img/Buying_guide10.png"></p>
            </div>
        </div>
        <div class="psright">
            <div class="prtop">
            ...
            <div class="answer">
                <ul>
                    ...
                    <p class="Buying_guide_pic"><img src="/img/entry_pic.png"></p>
        ...
        <div class="psright">
            ...
            <div class="answer">
                ...
                <p class="Buying_guide_pic"><img src="/img/Return_pic.png"></p>
                <p class="red_indent">点击取消按钮后，在弹出的<span style="color:#f00">取消订单申请</span>中填写申请理由。</p>
                <p class="Buying_guide_pic"><img src="/img/Return_pic1.png"></p>
        ...
        <div class="psright">
            ...
            <div class="answer">
                ...
                <p class="Buying_guide_pic"><img src="/img/Line_maintenance_pic1.png"></p>
                <p class="red_indent">点击立即申请按钮进入申请返修页面，填写相关信息。</p>
                <p class="Buying_guide_pic"><img src="/img/Line_maintenance_pic2.png"></p>
                <p class="Buying_guide_pic"><img src="/img/Line_maintenance_pic3.png"></p>
