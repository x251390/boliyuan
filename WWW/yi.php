...
<div class="top_man">
    <div class="top_box">
        <div class="top_nav_left spriteIcon">
                <span class="spriteIcon _stwid"></span>
	            <span>
	                <a href="/Home/Index/index.html">薄利圆首页</a>
	            </span>
        </div>
        <div class="al_tppi">
            <div class="use_dl">
                                    <a href="/Home/Login/login/type/user.html">登录</a>
                    <i>/</i>
                    <a href="/Home/Enroll/index.html">免费注册</a>            </div>
            <div class="use_shopp spriteIcon spriposi">
                                        <a href="javascript:" class="user_pop" id="shopping">购物车
                            <em class="csname">
                                0                            </em>件
                        </a>            </div>
            <div class="right_drowdon">
                <ul class="top_nav">
                    <!--当登陆账号是终端屏时  不显示我的薄利圆 和 我的订单-->
                    <li class="top_index">
                            <p class="bg_pg">
                                <a href="/Home/Index/index.html">我的薄利圆</a>
                                <span class="spriteIcon"></span>
                            </p>
                            <ul class="top_two">
                                <!-- <li><a href="">购物车<em class="csname">0</em>件</a></li> -->
                                <li>
                                                                            <a href="javascript:" class="user_pop">关注的商品</a>                                </li>

                                <li>
                                                                            <a href="javascript:" class="user_pop">关注的品牌</a>
                                </li>
                                <li>
                                                                            <a href="javascript:" class="user_pop">返修退换货</a>                                </li>
                                <li>
                                                                            <a href="javascript:" class="user_pop">我的积分</a>                                </li>
                                <li>
                                                                            <a href="javascript:" class="user_pop">促销优惠</a>
                                </li>
                                <li><a href="/Home/Flagship/seeMall.html">商城活动</a></li>
                        ...
                        <li class="top_index">
                            <p class="bg_pg"><a href="">我的订单</a><span class="spriteIcon"></span></p>
                            <ul class="top_two">
                                <li>
                                                                            <a href="javascript:" class="user_pop">全部订单</a>                                </li>

                            </ul>
                        </li>                    <li class="top_index">
                        <p class="bg_pg"><a href="">商家登录</a><span class="spriteIcon"></span></p>
                        <ul class="top_two">
                            <li><a href="/Shop/Login/index.html">店铺登录</a></li>
                            <li>
                                <a href="/Agent/Login/login.html">区域登录</a>
                                                                </li>
                            <li><a href="/Home/Login/login/type/terminal.html">终端登录</a></li>
                           
                        </ul>
                    </li>
                    <li class="top_index">
                        <p class="bg_pg"><a href="">招商加盟</a><span class="spriteIcon"></span></p>
                        <ul class="top_two">
                            <!--<li><a href="/Home/Join/mode.html">营运模式</a></li>-->
                            <li><a href="/Home/Join/firm.html">厂商列表</a></li>
                            <li><a href="/Home/Join/area.html">区域代理</a></li>
                          
                        </ul>
                    </li>
                    <li class="top_index">
                        <p class="bg_pg"><a href="">客服中心</a><span class="spriteIcon"></span></p>
                        <ul class="top_two">
                            <li><a href="/Home/Kf/kf.html">联系客服</a></li>
                            <li>
                                                                    <a href="javascript:" class="user_pop">投诉建议</a>                            </li>
                            <li><a href="/Process/process.html">更多服务</a></li>
                        </ul>
                    </li>
                </ul>
                <div class="kutxt">
                    <p><a href="">客服专线：<span>400-600-5525</span></a></p>
                </div>
            </div>
        </div>    
    </div>
...
<div class="logo_box" style="background:url(/Public/Home/images/index_main_bg5.png) no-repeat;background-size: 1200px 139px">
    <div class="logo">
        <a href="/Index/index.html"><img src="/Public/Home/images/cop_index_logo.png"></a>
    </div>
</div>
<div class="lj">
    <div class="photo">
        ...
        <div class="use_nav">
            <ul>
                <li>
                    <a href="/Home/Kf/kf.html" class="coloff">联系客服</a>
                </li>
                <li>
                                            <a href="javascript:"  class="user_pop coloff">投诉建议</a>                </li>
                <li>
                    <a href="/Process/process.html" class="coloff2 coloff1">更多服务</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="psmain main_list">
    <div class="psleft">
        <ul>
            <li class="pstop ding"><a href="/Process/process.html?id=0">线下体验<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=1">关于积分<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=2">订购流程<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=3">购买指南<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=4">收货指南<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=5">上门提货<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=6">服务费用<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=7">退款流程<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=8">维修说明<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=9">品质保证<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=10">隐私保护<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=11">免责说明<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=12">法律援助<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=13">无忧服务<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=14">千万好评<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=15">联系我们<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=16">物流配送<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=17">安装指南<i>></i></a></li>
            <li class="pstop"><a href="/Process/process.html?id=18">注册协议<i>></i></a></li>
        </ul>
    </div>
...
<div class="footer">
    <ul>
        <li class="fot1"><a href="/Home/Company/progress.html">关于薄利圆</a></li>
        <li class="fot1"><a href="/Home/Join/mode.html">招商加盟</a></li>
        <li class="fot1"><a href="/Home/News/industry.html">行业资讯</a></li>
        <li class="fot1"><a href="/Home/SignInMNA/PurchaseCommonSense.html">选购常识</a></li>
        <li class="fot1"><a href="/Home/Serve/dispatching.html">服务承诺</a></li>
        <li><a href="/Home/Recruit/concept.html">招贤纳士</a></li>
    </ul>
</div>
<div class="bottom">
    <div class="bot_name">
        <span class="bot_fl">成都正海文化传播有限公司版权所有</span>
        <span class="bot_far">备案号：蜀ICP备17013285号</span>
    </div>
</div>
</body>
<script>
...
<script type="text/javascript">
    $(function(){
        ...
        $(".pstop").eq(index_number+1).css({background: "#82878b"});
        $(".pstop a").eq(index_number+1).css({color: "#fff"});
