...
<div id="company_manment">
    ...
    <div class="c_i_bigBg opb_bigBg" >

    </div>
    <div class="mgAu1200 opb_mian">
        <div class="o_m_title">
            <img src="/img/opb_title.png" alt="">
        </div>
        <div class="o_m_wrap">
           <p><img src="/img/opb_txt1.png" alt=""></p>
            <div class="m_w_center">
                <p class="">年度期权额度：</p>
                <p class="">公司划拨薄利圆30%内部期权股份作为团队参与成员年度净利润分红</p>
                <p class="">年度期权分配比例：</p>
                <p class="">正海文化传播全体团队成员年度内部期权分红具体分配比例为：职能部门人员及公司管理人员全体占比10%，省区营销总监全体占比5%，区域营销经理全体占比15%。</p>
            </div>

           <p><img src="/img/opb_mainBg1.png" alt=""></p>
        </div>
...
<script type="text/javascript">
 var $nav_dd=$('.c_i_nav dl dd');	
		...
		$nav_dd.eq(2).addClass('active').siblings().removeClass('active');
</script>
</html>