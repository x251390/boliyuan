...
<div id="company_manment">
    ...
    <div class="c_i_bigBg m_i_bigBg" >

    </div>
    <div class="m_i_mian mgAu1200">
        <img src="/img/mi-mian.jpg" alt="">
        <div class="m_i_txt1">
            <p>To the small boliyuan customers</p>
            <p>Highquality presale, sale, aftersales service.</p>
        </div>
        <div class="m_i_btn">
            <a href="javascript:">
                BOLIYUAN
